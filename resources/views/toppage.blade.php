...
<audio src="{{ URL::asset('image/ship.mp3') }}" autoplay="autoplay"></audio>

<div class="container">
  {!! Form::open(array('url' => '/credentials')) !!}
    
    <h2>Create Your Top page</h2>
    <div class="row">
      <div class="col-md-6">
        <div class="form-group">
          <label for="first">Assignment No</label>
          <input type="text" required="true" class="form-control" name="assignment_no" placeholder="Assignment No">
        </div>
      </div>
      <!--  col-md-6   -->
      ...
      <div class="col-md-6">
        <div class="form-group">
          <label for="first">Assignment Title</label>
          <input type="text" required="true" class="form-control" name="assignment_title" placeholder="Assignment Title">
        </div>
      </div>
      <!--  col-md-6   -->
    </div>
...
<div class="col-md-6">
        ...
        <div class="form-group">
           <label for="first">Submitted To</label>
          <input type="text" required="true" class="form-control" name="teacher" placeholder="ex:Dr. Md. Refayet Ullah">
        </div>
      </div>
...
<div class="form-group">
  <label for="designation">Teacher's Designation List</label>
...
<div class="input-group date" data-provide="datepicker" data-date-format='dd-mm-yyyy'>
    <input type="text" name="date" required="true"  placeholder="DD/MM/YYYY" class="form-control">
...
<div class="col-md-6">
        ...
        <div class="form-group">
         <label for="first">Assignment Partners Credentials</label>
...
<h2 class="text-center">Please Be Advised,You should fill up your assignment partners credentials as the instruction says.Otherwise,it will be resulted in an error.</h2>
